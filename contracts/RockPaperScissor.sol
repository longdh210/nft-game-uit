...
contract RockPaperScissor is ERC721URIStorage, Ownable {
  ...
  constructor(string memory _name, string memory _symbol, address marketplaceAddress)
  ...
  // Creation
  function _createCard(string memory tokenURI) internal {
  ...
  function createRandomCard(string memory tokenURI) public payable {
    require(msg.value >= fee);
    _createCard(tokenURI);
  }
